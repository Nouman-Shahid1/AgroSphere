...
const RentalTable = () => {
  ...
  return (
    <div className="p-2 md:p-6 z-50">
      <div className="mb-6 flex flex-col lg:flex-row items-center justify-between px-6 py-8 bg-gradient-to-r from-green-700 via-green-800 to-green-900 text-white rounded-3xl shadow-lg">
        <div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:space-x-4">
          ...
          {/* Search Input */}
          <div className="flex items-center text-black mt-3 md:mt-0">
            <input
              type="text"
      ...
      <div className="overflow-x-auto bg-gradient-to-r from-green-700 via-green-800 to-green-900 text-white shadow-md rounded-3xl">
        <table className="min-w-full text-sm">
          <thead>
            <tr className=" bg-gradient-to-r from-green-700 via-green-800 to-green-900 text-white">
          ...
          <tbody>
            {filteredRentals.length > 0 ? (
              filteredRentals.map((rental) => (
                <tr key={rental.id} className="bg-green-100 border-b hover:bg-green-50">
